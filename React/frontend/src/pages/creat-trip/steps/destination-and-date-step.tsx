...
export function DestinationAndDateStep({
    ...
    const displayDate = eventStartAndEndDate && eventStartAndEndDate.from && eventStartAndEndDate.to
    ...
    return (
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-5">
            ...
            <button onClick={openDatePicker} disabled={isGuestInputOpen} className='flex items-center gap-2 flex-1 text-left'>
