                        ...
                        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-5">
                            <button type='button' onClick={openGuestsModal} className='flex items-center gap-2 flex-1 text-left'>
                                ...
                                {emailsToInvite.length > 0 ? (
                                    <span className='text-zinc-100 text-lg flex-1'>{emailsToInvite.length} pessoa(s) conmvidada(s)</span>
                ...
                <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
                    <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                        <div className='space-y-2'>
                            ...
                            <p className='text-sm text-zinc-400'>Para concluir a criação da viagem para <span className='text-zinc-100 font-semibold'>Florianópolis, Brasil</span> nas datas de <span className='text-zinc-100 font-semibold'>16 a 27 de Agosto de 2024</span> preencha seus dados abaixo:
                        ...
                        <form onSubmit={addNewEmailToInvite} className='space-y-3'>
                            ...
                            <button type='submit' className='bg-lime-300 text-lime-950 rounded-lg px-5 h-11 flex items-center gap-2 hover:bg-lime-400 w-full justify-center'>
                                Confirmar criaçãp da viagem
                            </button>
                        </form>
